...
class nusoap_xmlschema extends nusoap_base
{
    ...
    function parseString($xml, $type)
    {
        ...
        if (!xml_parse($this->parser, $xml, true)) {
            ...
            $errstr = sprintf('XML error parsing XML on line %d: %s',
                $lineNumber,
                xml_error_string($errorCode)
            );
            $this->logError($errstr);
            $this->setError('An error occurred while processing your request.'); // Generic error message
        }
...
//		}
     ...
     * @access   public
     */
    function sendHTTPS($data, $timeout = 0, $response_timeout = 300, $cookies = NULL)
    {
...
class wsdl extends nusoap_base
{
     ...
     * @access public
     */
    function __construct($wsdl = '', $proxyhost = false, $proxyport = false, $proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 300, $curl_options = null, $use_curl = false)
    {
        parent::__construct();
...
class nusoap_client extends nusoap_base
{
     ...
     * @access   public
     */
    function __construct($endpoint, $wsdl = false, $proxyhost = false, $proxyport = false, $proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 300, $portName = '')
    {
        parent::__construct();
		...
		$this->setCredentials($_SESSION["currentUser"],$_SESSION["token"]. "@". $_SESSION['loginip']);
        // make values
        if ($wsdl) {
