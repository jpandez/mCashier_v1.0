		...
		<div id="mposrevenuereport" style="width:100%;font-size:10px;">
			<?php $transactionhistorydata = $this->data("transactionhistorydata"); ?>
				<?php if(isset($transactionhistorydata->ResponseCode)){ ?>
					...
					<div>
						<!--<a href="<?php echo $GLOBALS['CONTROLLER_PATH']; ?>/ViewControllers/user.reports.mposrevenuereport.php?Method=ExportSMposRevenueReportCSV&TransHdatefrom=<?php echo $_REQUEST['TransHdatefrom'];?>&TransHdateto=<?php echo $_REQUEST['TransHdateto'];?>&queryCount=<?php echo $transactionhistorydata->QueryCount;?>">
							<img src="<?php echo $GLOBALS['VIEW_PATH'];?>images/export_csv.png" border="0" alt="logo" />CSV
						</a>
						<a href="<?php echo $GLOBALS['CONTROLLER_PATH']; ?>/ViewControllers/user.reports.mposrevenuereport.php?Method=ExportSMposRevenueReportPDF&TransHdatefrom=<?php echo $_REQUEST['TransHdatefrom'];?>&TransHdateto=<?php echo $_REQUEST['TransHdateto'];?>&queryCount=<?php echo $transactionhistorydata->QueryCount;?>" >
							<img src="<?php echo $GLOBALS['VIEW_PATH'];?>images/export_pdf.png" border="0" alt="logo" />PDF
						</a>-->
						<a href="<?php echo $GLOBALS['CONTROLLER_PATH']; ?>/ViewControllers/user.reports.smposrevenuereport.php?Method=ExportSMposRevenueReportEXCEL&TransHdatefrom=<?php echo $_REQUEST['TransHdatefrom'];?>&TransHdateto=<?php echo $_REQUEST['TransHdateto'];?>&queryCount=<?php echo $transactionhistorydata->QueryCount;?>">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="display" width="100%" id="reports_transactionHistory">
						...
						<tr class="ui-widget-header">
							<th><?php echo _("CARD SCHEME"); ?></th>
							<th><?php echo _("ON BOARDED BY"); ?></th>
						...
						<tfoot>
							...
							<tr>
								<?php $part = explode(":", $transactionhistorydata->QuerySum); ?>
								<th></th>
								<th>TOTAL</th>
...
<script type="text/javascript">
	$(function(){
		...
		ht = ht.replace("px","");
		$("#if_reports_smposrevenue",window.parent.document).css('height',parseInt(ht)+200);
	});
