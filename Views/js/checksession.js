...
/*================================================================================*/
      ...
      window.sessionCallback = function(res){if(res.ResponseCode != 0 && window.dialogIsOpen == "false"){window.dialogIsOpen = "true";$("<p>You have been logged out!</p>").dialog({resizable:false,modal:true, buttons: { "Ok": function() {window.location = "../../Controllers/ViewControllers/logout.php"; $(this).dialog("close"); } } }).parent().find('a.ui-dialog-titlebar-close').remove();}};
