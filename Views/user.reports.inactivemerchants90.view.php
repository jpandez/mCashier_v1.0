		...
		<div id="registeredmerchants" style="width:100%;font-size:10px;">
			<?php $registeredmerchantsdata = $this->data("registeredmerchantsdata"); ?>
				<?php if(isset($registeredmerchantsdata->ResponseCode)){ ?>
					...
					<div>
						<a href="<?php echo $GLOBALS['CONTROLLER_PATH']; ?>/ViewControllers/user.reports.inactivemerchants90.php?Method=ExportRegisteredMerchantsCSV&selecttype=<?php echo $_REQUEST['selecttype'];?>&queryCount=<?php echo $registeredmerchantsdata->QueryCount;?>">
							<img src="<?php echo $GLOBALS['VIEW_PATH'];?>images/export_csv.png" border="0" alt="logo" />CSV
						</a>
						<!--<a href="<?php echo $GLOBALS['CONTROLLER_PATH']; ?>/ViewControllers/user.reports.inactivemerchants90.php?Method=ExportregisteredmerchantsPDF&type=<?php echo $_REQUEST['type'];?>&TransHdatefrom=<?php echo $_REQUEST['TransHdatefrom'];?>&TransHdateto=<?php echo $_REQUEST['TransHdateto'];?>&queryCount=<?php echo $registeredmerchantsdata->QueryCount;?>" >
							<img src="<?php echo $GLOBALS['VIEW_PATH'];?>images/export_pdf.png" border="0" alt="logo" />PDF
						</a>-->
						<a href="<?php echo $GLOBALS['CONTROLLER_PATH']; ?>/ViewControllers/user.reports.inactivemerchants90.php?Method=ExportRegisteredMerchantsEXCEL&selecttype=<?php echo $_REQUEST['selecttype'];?>&queryCount=<?php echo $registeredmerchantsdata->QueryCount;?>">
							<img src="<?php echo $GLOBALS['VIEW_PATH'];?>images/export_excel.png" border="0" alt="logo" />EXCEL
						</a>
					</div>
					<div class="demo_jui">
					<div style="margin-top:15px";></div>
					<form id="searchPagination" action="<?php echo $GLOBALS['CONTROLLER_PATH']; ?>/ViewControllers/user.reports.inactivemerchants90.php" method="post">
...
<script type="text/javascript">
	$(function(){
		...
		ht = ht.replace("px","");
		$("#if_reports_inactivemerchants90",window.parent.document).css('height',parseInt(ht)+200);
	});
