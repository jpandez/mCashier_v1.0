...
<div id="approved" class="_approved">
<div id="accountsummary" class="_accountsummary">
<?php $approvedsubscriber = $this->data("subscriberPending"); ?>
<?php if(isset($approvedsubscriber->ResponseCode)){ ?>
	<?php if(is_array($approvedsubscriber->Value)){?>
		<div class="_m-top"></div>
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="approvedaccount" width="100%">
			<thead>
			<tr class="ui-widget-header">
							<th><?php echo _("REGISTRATION ID"); ?>
			...
			<tbody>
				<?php $ctr=0; foreach($approvedsubscriber->Value as $t): $ctr++;?>
	...
	<?php } 
			...
			echo "<h3>". $approvedsubscriber->Message ."</h3>";
		}?>
<?php } ?>
</div>
