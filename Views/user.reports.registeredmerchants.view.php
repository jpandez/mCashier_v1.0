		...
		<div id="registeredmerchants" style="width:100%;font-size:10px;">
			...
			<?php $registeredmerchantsdata = $this->data("registeredmerchantsdata"); ?>
				<?php if(is_array($registeredmerchantsdata->Value)){ if (!isset($_REQUEST['pagenum']) || !isset($_REQUEST['perpage'])){$_REQUEST['pagenum']=1; $_REQUEST['perpage']=15;} ?>
					<div>
						<a href="<?php echo $GLOBALS['CONTROLLER_PATH']; ?>/ViewControllers/user.reports.registeredmerchants.php?Method=ExportRegisteredMerchantsCSV&selecttype=<?php echo $_REQUEST['selecttype'];?>&queryCount=<?php echo $registeredmerchantsdata->QueryCount;?>">
							<img src="<?php echo $GLOBALS['VIEW_PATH'];?>images/export_csv.png" border="0" alt="logo" />CSV
						</a>
						<!--<a href="<?php echo $GLOBALS['CONTROLLER_PATH']; ?>/ViewControllers/user.reports.registeredmerchants.php?Method=ExportregisteredmerchantsPDF&type=<?php echo $_REQUEST['selecttype'];?>&TransHdatefrom=<?php echo $_REQUEST['TransHdatefrom'];?>&TransHdateto=<?php echo $_REQUEST['TransHdateto'];?>&queryCount=<?php echo $registeredmerchantsdata->QueryCount;?>" >
							<img src="<?php echo $GLOBALS['VIEW_PATH'];?>images/export_pdf.png" border="0" alt="logo" />PDF
						</a>-->
						<a href="<?php echo $GLOBALS['CONTROLLER_PATH']; ?>/ViewControllers/user.reports.registeredmerchants.php?Method=ExportRegisteredMerchantsEXCEL&selecttype=<?php echo $_REQUEST['selecttype'];?>&queryCount=<?php echo $registeredmerchantsdata->QueryCount;?>">
					...
					<form id="searchPagination" action="<?php echo $GLOBALS['CONTROLLER_PATH']; ?>/ViewControllers/user.reports.registeredmerchants.php" method="post">
					<input type="hidden" name="selecttype" value="ETISALAT" />
