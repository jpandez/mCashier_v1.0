...
<div id="BankInfoTabHolder" class="BankInfoTabHolder" style="border:0px solid;height:230px;width:1100px;display:none;">
	<div class="panelButtons" style="margin-bottom:10px;">
		...
		-->
		<?php if($this->getRolesConfig('UPDATE_VATFUNCTIONALITY')) { ?>
		<a href="#" id="btnEditVATFunc" class="ui-state-default ui-corner-all ui-button"><?php echo _("Edit VAT Functionality"); ?></a>
		<a href="#" id="btnUpdateVATFunc" class="ui-state-default ui-corner-all ui-button" style="display:none;"><?php echo _("Save VAT Functionality"); ?></a>
		
		<?php } ?>
		
		<?php } ?>
		<?php if($this->getRolesConfig('UPDATE_MSISDN')) { ?>
		<a href="#" id="btnEditMSISDN" name="btnEditMSISDN" class="ui-state-default ui-corner-all ui-button"><?php echo _("Edit MSISDN"); ?></a>
		
		<?php } ?>
	</div>
	<!--<div align="left"><a href="<?php echo $GLOBALS['CONTROLLER_PATH']; ?>/ViewControllers/user.download2.file.php?msisdn=<?php echo isset($account)?$account->MobileNumber:""; ?>"><?php echo _("Application File"); ?></a></div>-->
	...
	<div class="bank_info_details" style="border:0px solid red;width:450px;margin-top:5px;margin-right:30px;float:left;">
		<table border="0" id="tblAccount3" cellspacing="5" class="tablet">
			...
			<tr>
				...
				<tr>
					<?php if($account->AccountType == "MADM") { ?>
						<td><?php echo _("TRN"); ?>:</td>
						<td><input type="text" id="TRN" disabled="disabled" value="<?php echo $account==null?"":$account->TRN ?>"></td>					
					<?php } ?>
				</tr>
		...
		<div class="bank_info_details" style="border:0px solid red;width:450px;margin-top:5px;margin-right:10px;float:left;">
			<table border="0" id="tblAccount3" cellspacing="5" class="tablet">
				...
				<tr><td><?php echo _("First Name"); ?><span style="color:red">*</span>:</td><td><input type="text" id="pFName" disabled="disabled" value="<?php echo $account==null?"":$account->PersonalInformation->FirstName ?>">
				<input id="accountidqwert" value="<?php echo $account==null?"":$account->AccountID ?>" hidden>
				</td></tr>
				...
				<tr><td><?php echo _("Merchant ID"); ?><span style="color:red">*</span>:</td><td><input type="text" id="pMID" disabled="disabled" value="<?php echo $account==null?"":$account->merchantid ?>"></td></tr>
				<tr><td><?php echo _("Terminal ID"); ?><span style="color:red">*</span>:</td><td><input type="text" id="pTID" disabled="disabled" value="<?php echo $account==null?"":$account->terminalid ?>"></td></tr>
			...
			<div class="containeruploadfiles" style="border:0px solid #606060;width:100%;margin-top:20px;float:left;margin-bottom:80px;">
				<div class="viewuploadedfiles" style="border:1px solid #c6c2c2; border-radius:7px;width:47%;margin-top:0px;float:right; background-color:#f7f7f7;  height:215px; overflow: scroll; overflow-x: hidden; padding:10px;">
					<div style="float:left;">
						<h3>Uploaded Merchant Files</h3>
						<?php if(1 <= $searchResult->BNKfileCount){ ?>
							<a id="checkID"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File1");} ?></a></br></br>
						<?php } ?>
						<?php if(2 <= $searchResult->BNKfileCount){ ?>
							<a id="checkID2"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File2");} ?></a></br></br>
						<?php } ?>
						<?php if(3 <= $searchResult->BNKfileCount){ ?>
							<a id="checkID3"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File3");} ?></a></br></br>
						<?php } ?>
						<?php if(4 <= $searchResult->BNKfileCount){ ?>
							<a id="checkID4"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File4");} ?></a></br></br>
						<?php } ?>
						<?php if(5 <= $searchResult->BNKfileCount){ ?>
							<a id="checkID5"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File5");} ?></a></br></br>
						<?php } ?>
						<?php if(6 <= $searchResult->BNKfileCount){ ?>
							<a id="checkI6"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File6");} ?></a></br></br>
						<?php } ?>
						<?php if(7 <= $searchResult->BNKfileCount){ ?>
							<a id="checkID7"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File7");} ?></a></br></br>
						<?php } ?>
						<?php if(8 <= $searchResult->BNKfileCount){ ?>
							<a id="checkID8"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File8");} ?></a></br></br>
						<?php } ?>
						<?php if(9 <= $searchResult->BNKfileCount){ ?>
							<a id="checkID9"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File9");} ?></a></br></br>
						<?php } ?>
						<?php if(10 <= $searchResult->BNKfileCount){ ?>
							<a id="checkID10"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File10");} ?></a></br></br>
						<?php } ?>
					</div>	
				</div>
				<div class="viewuploadedfiles" style="border:1px solid #c6c2c2; border-radius:7px;width:47%;margin-top:0px;float:right; background-color:#f7f7f7;  height:215px; overflow: scroll; overflow-x: hidden; padding:10px;">
					<div style="float:left;">
						...
						<?php if(1 <= $searchResult->QCfileCount){ ?>
							<a id="BcheckID"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File1");} ?></a></br></br>
						<?php } ?>
						<?php if(2 <= $searchResult->QCfileCount){ ?>
							<a id="BcheckID2"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File2");} ?></a></br></br>
						<?php } ?>
						<?php if(3 <= $searchResult->QCfileCount){ ?>
							<a id="BcheckID3"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File3");} ?></a></br></br>
						<?php } ?>
						<?php if(4 <= $searchResult->QCfileCount){ ?>
							<a id="BcheckID4"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File4");} ?></a></br></br>
						<?php } ?>
						<?php if(5 <= $searchResult->QCfileCount){ ?>
							<a id="BcheckID5"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File5");} ?></a></br></br>
						<?php } ?>
						<?php if(6 <= $searchResult->QCfileCount){ ?>
							<a id="BcheckI6"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File6");} ?></a></br></br>
						<?php } ?>
						<?php if(7 <= $searchResult->QCfileCount){ ?>
							<a id="BcheckID7"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File7");} ?></a></br></br>
						<?php } ?>
						<?php if(8 <= $searchResult->QCfileCount){ ?>
							<a id="BcheckID8"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File8");} ?></a></br></br>
						<?php } ?>
						<?php if(9 <= $searchResult->QCfileCount){ ?>
							<a id="BcheckID9"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File9");} ?></a></br></br>
						<?php } ?>
						<?php if(10 <= $searchResult->QCfileCount){ ?>
							<a id="BcheckID10"><?php if($this->getRolesConfig('DOWNLOAD_APPLICATION_FILE')){echo _("Application File10");} ?></a></br></br>
						<?php } ?>
					</div>	
				</div>
			</div>
...
<div id="msisdnUpdate" style="display:none;" title="UPDATE MSISDN">
	<div style="margin-bottom:20px;">
		<button  id="btnUpdateMSISDN" name="btnUpdateMSISDN" type = "button" class="ui-button ui-state-default ui-corner-all"><?php echo _("Request"); ?></button>
	</div>
	<div>
		<table  style="width:90	%">
			<tr>
				<td><?php echo _("Old MSISDN: "); ?></td>
				<td><input type="text" id="oldMSISDN" value="<?php echo isset($account)?$account->MobileNumber:"" ?>" disabled></td>
			</tr>
			<tr><td></br></td><td></br></td</tr>
			<tr>
				<td><?php echo _("MID: "); ?></td>
				<td><input type="text" id="MID" value="<?php echo isset($account)?$account->merchantid:"" ?>" disabled></td>
			</tr>
			<tr><td></br></td><td></br></td</tr>
			<tr>
				<td><?php echo _("TID: "); ?></td>
				<td><input type="text" id="TID" value="<?php echo isset($account)?$account->terminalid:"" ?>" disabled></td>
			</tr>
			<tr><td></br></td><td></br></td</tr>
			<tr>
				<td><?php echo _("New MSISDN: "); ?></td>
				<td><input id="newMSISDN" name="newMSISDNisvalid" type="text" onkeyup="this.value=this.value.replace(/\D/g,'');  updatemsisdn();"></td>
				<td><?php echo _("MSISDN Validity"); ?>:</td>
				<td>
					<div class="field required">
						<input type="text" name="msisdnValidity" id="msisdnValidity" disabled="disabled" >
					</div>
				</td>
			</tr>
		</table>
...
<script>
	...
	$('#msisdnUpdate').dialog({
		...
		$('#btnEditMSISDN').click(function(){
				$('#msisdnUpdate').dialog('open');
		});
...
if (doPrevent) {
	...
	<?php
	echo isset($account)
		? (strtoupper(trim($account->KYC)) == "APPROVED"
			? 'var _0x3de0=["\x72\x65\x6D\x6F\x76\x65","\x23\x64\x69\x76\x4B\x59\x43"];$(_0x3de0[1])[_0x3de0[0]]();'
			: ($_SESSION['ViewKYC'] == "NO"
				? 'var _0x3de0=["\x72\x65\x6D\x6F\x76\x65","\x23\x64\x69\x76\x4B\x59\x43"];$(_0x3de0[1])[_0x3de0[0]]();'
				: ($account->UserID == $_SESSION["currentUser"]
					? 'var _0x3de0=["\x72\x65\x6D\x6F\x76\x65","\x23\x64\x69\x76\x4B\x59\x43"];$(_0x3de0[1])[_0x3de0[0]]();'
					: ''
				)
			)
	...
	echo isset($account)
		? (strtoupper(trim($account->KYC)) == "APPROVED"
			? 'var _0x4874=["\x72\x65\x6D\x6F\x76\x65","\x23\x64\x69\x76\x4B\x59\x43"];$(_0x4874[1])[_0x4874[0]]();'
			: ($_SESSION['ViewKYC'] == "NO"
				? 'var _0x4874=["\x72\x65\x6D\x6F\x76\x65","\x23\x64\x69\x76\x4B\x59\x43"];$(_0x4874[1])[_0x4874[0]]();'
				: ($account->UserID == $_SESSION["currentUser"]
					? 'var _0x4874=["\x72\x65\x6D\x6F\x76\x65","\x23\x64\x69\x76\x4B\x59\x43"];$(_0x4874[1])[_0x4874[0]]();'
	...
	function SearchNationality(){
		var params = {
			...
			$.ajax({url:service_url,
				...
				$("#checkID").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"1"+"&ftype="+"QC");
				$("#checkID2").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"2"+"&ftype="+"QC");
				$("#checkID3").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"3"+"&ftype="+"QC");
				$("#checkID4").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"4"+"&ftype="+"QC");
				$("#checkID5").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"5"+"&ftype="+"QC");
				$("#checkID6").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"6"+"&ftype="+"QC");
				$("#checkID7").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"7"+"&ftype="+"QC");
				$("#checkID8").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"8"+"&ftype="+"QC");
				$("#checkID9").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"9"+"&ftype="+"QC");
				$("#checkID10").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"10"+"&ftype="+"QC");

				$("#BcheckID").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"1"+"&ftype="+"BANK");
				$("#BcheckID2").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"2"+"&ftype="+"BANK");
				$("#BcheckID3").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"3"+"&ftype="+"BANK");
				$("#BcheckID4").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"4"+"&ftype="+"BANK");
				$("#BcheckID5").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"5"+"&ftype="+"BANK");
				$("#BcheckID6").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"6"+"&ftype="+"BANK");
				$("#BcheckID7").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"7"+"&ftype="+"BANK");
				$("#BheckID8").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"8"+"&ftype="+"BANK");
				$("#BcheckID9").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"9"+"&ftype="+"BANK");
				$("#BheckID10").attr("href", download_url + "msisdn=" + $("#authNumber").val() + "&" + "smbBoolean=" + true+"&"+"image="+"10"+"&ftype="+"BANK");
...
var download_url = "<?php echo $GLOBALS['CONTROLLER_PATH']; ?>/ViewControllers/user.download2.file.php?";
		...
		function searchIdDescription(){
			...
			$("#newMSISDNisvalid").bind('textchange', function(){	
				updatemsisdn();
			});
			...
			$("#btnEditPInfo").click(function(){
				...
				$('#btnUpdatePInfo').show();
				$('#btnCancelPInfo').show();
				$('#authNumber, #selectedType, #pMID, #pTID, #corpcontactno').attr('disabled','disabled');
				//$("input[type=radio]").attr('disabled', false);
			});
			$("#btnEditVATFunc").click(function(){
				$("input[type=radio]").attr('disabled', false);
				$("#btnEditVATFunc").hide();
				$("#btnUpdateVATFunc").show();
			});
			$("#btnUpdateVATFunc").click(function(){
				//$("input[type=radio]").attr('disabled', true); edited 04122019
				$("#btnEditVATFunc").show();
				$("#btnUpdateVATFunc").hide();
			});
			...
			//alert($("#vatsetter").val());
					//alert(<?php echo $account->AccountID ?>);
					var id = <?php echo $account->AccountID ?>;
					//alert(id);
				var params = {
					Method:'updateVAT',
					ID:id,
			...
			$('#btnUpdateMSISDN').click(function(){
			$("#btnUpdateMSISDN").attr("disabled", true);
			var params = {
					Method:'requestUpdateMSISDN',
	...
	var params = {Method:'validateMSISDN',inp:$("#newMSISDN").val(),FToken:($('meta[name="csrf-token"]').attr('content')) ? $('meta[name="csrf-token"]').attr('content') : window.parent.$('meta[name="csrf-token"]').attr('content')};			
		$.ajax({
			url:service_url,
			type:"POST", 
			data:params,
