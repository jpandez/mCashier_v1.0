...
<?php
	class SubscriberTransactionsController extends ViewController{
		public function __construct(){
					...
					case "TransactionFailed":
						if($_REQUEST["TransFdatefrom"] != '' && $_REQUEST["TransFdateto"] != ''){
							...
							if($_SESSION['searchrange'] > $datediff){
								...
								$ret = $serv->transactionFailed($_REQUEST["TransFdatefrom"],$_REQUEST["TransFdateto"],$_REQUEST["perpage"],$_REQUEST["pagenum"]);
								
								$this->setData("transactionfaileddata",$ret);
							if(isset($ret->Token)){
			...
			$this->setMaster("user.reports.transactionfailed.view.php");
			$this->render();
		}
	}
